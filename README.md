...
(5) In the demo script, Line 164, Line 189, and Line 214, change the path to your local python environment (the one you install the deep learning dependencies)

(6) Run the demo script, type demo_multiparametric_water_recon in the MATLAB command line
