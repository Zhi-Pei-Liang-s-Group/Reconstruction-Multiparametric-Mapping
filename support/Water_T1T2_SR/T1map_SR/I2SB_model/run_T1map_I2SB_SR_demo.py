...
# -*- coding: utf-8 -*-
"""
Run I2SB super-resolution inference for T1 maps on the MRx demo data.

Usage example:
    python run_T1map_I2SB_SR_demo.py \
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run T1map I2SB SR inference.")
