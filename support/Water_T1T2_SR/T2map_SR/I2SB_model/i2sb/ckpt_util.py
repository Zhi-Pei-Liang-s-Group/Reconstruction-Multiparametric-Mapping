...
def download_adm_image256_uncond_ckpt(ckpt_dir="data/"):
    ...
    ckpt_state_dict["input_blocks.0.0.weight"] = ckpt_state_dict["input_blocks.0.0.weight"][:,:1]
    ckpt_state_dict["out.2.weight"] = ckpt_state_dict["out.2.weight"][:1]
    ckpt_state_dict["out.2.bias"] = ckpt_state_dict["out.2.bias"][:1]
...
def download_adm_image256_cond_ckpt(ckpt_dir="data/"):
    ...
    ckpt_state_dict['input_blocks.0.0.weight'] = torch.cat([
        ckpt_state_dict['input_blocks.0.0.weight'][:,-1:],
        model.input_blocks[0][0].weight.data[:, 1:]
    ], dim=1)
